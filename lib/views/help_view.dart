      ...
      body: SingleChildScrollView(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              _sectionHeader('Pulse Wave Overview:'),
              _point(
                  'Pulse Wave is a simple OSC (Open Sound Control) app for modifying messages on phones/tablets.'),
              _point(
              ...
              _point('Input the IP in Pulse Wave\' "network" button.'),
